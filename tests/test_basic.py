"""Basic functionality tests for VoiceStream PBX Microservice"""
...
async def test_packet_ingestion_out_of_order(async_client):
    ...
    # Send packets: 0, 1, 2, 5 (gap at 3, 4)
    sequences = [0, 1, 2, 5]
...
async def test_duplicate_packet_detection(async_client):
    ...
    # Note: Duplicate detection happens in background task
